    ...
    public void seedDatabase() throws SQLException {
        try (Statement stmt = connection.createStatement()) {
            ...
            stmt.executeUpdate("""
                        ...
                        VALUES  ('Planet Fitness', 30.0, 8000.0, 'PENDING', 1, 10.0),
                                ('Restaurant', 30.0, 12000.0, 'PENDING', 1, 10.0),
                                ('School', 30.0, 12000.0, 'PENDING', 1, 10.0),
                                ('Hotel', 30.0, 12000.0, 'PENDING', 1, 10.0),
                                ('SuperMarket', 30.0, 12000.0, 'PENDING', 2, 10.0),
                                ('Car wash', 30.0, 12000.0, 'PENDING', 2, 10.0);
                    """);

            stmt.executeUpdate("""
                        INSERT INTO materiaux (name, taxrate, unitcost, quantity, transportcost, qualitycoefficient, project_id)
                        VALUES   ('Cement', 18.0, 50.0, 100.0, 200.0, 1.0, 1),
                                 ('Steel Rebars', 20.0, 75.0, 150.0, 300.0, 1.2, 2),
                                 ('Bricks', 15.0, 60.0, 120.0, 250.0, 1.1, 1),
                                 ('Gravel', 10.0, 40.0, 200.0, 180.0, 0.9, 2),
                                 ('Sand', 8.0, 30.0, 180.0, 160.0, 0.95, 3),
                                 ('Concrete Mix', 22.0, 85.0, 90.0, 350.0, 1.3, 3),
                                 ('Wood Planks', 12.0, 55.0, 130.0, 220.0, 1.05, 4),
                                 ('White Paint', 10.0, 20.0, 50.0, 100.0, 0.98, 5),
                                 ('Primer', 15.0, 25.0, 30.0, 90.0, 1.0, 4),
                                 ('Exterior Paint', 18.0, 45.0, 70.0, 150.0, 1.1, 3),
                                 ('PVC Pipes', 5.0, 10.0, 200.0, 50.0, 0.92, 1),
                                 ('Faucets', 20.0, 60.0, 40.0, 75.0, 1.2, 2),
                                 ('Water Heater', 25.0, 150.0, 10.0, 300.0, 1.3, 5),
                                 ('Copper Wires', 10.0, 30.0, 300.0, 100.0, 1.0, 6),
                                 ('Light Bulbs', 5.0, 5.0, 100.0, 20.0, 1.05, 3),
                                 ('Circuit Breaker', 15.0, 100.0, 15.0, 200.0, 1.25, 6);
                    """);

            // Seed data into maindœuvre table
            stmt.executeUpdate("""
                        INSERT INTO maindœuvre (name, taxrate, hourlyrate, workhourscount, productivityrate, project_id)
                        VALUES  ('Mason', 18.0, 20.0, 40.0, 1.0, 1),
                                ('Electrician', 20.0, 25.0, 35.0, 1.1, 2),
                                ('Plumber', 15.0, 22.0, 30.0, 1.05, 3),
                                ('Painter', 12.0, 18.0, 25.0, 0.95, 4),
                                ('Carpenter', 18.0, 23.0, 45.0, 1.0, 4),
                                ('Welder', 22.0, 30.0, 20.0, 1.2, 2),
                                ('Roofer', 19.0, 27.0, 50.0, 1.15, 1),
                                ('General Laborer', 10.0, 15.0, 60.0, 0.9, 2);
                    """);
